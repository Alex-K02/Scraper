...
my_filter_start_date = (datetime.datetime.now() - timedelta(hours=1))  # datetime.datetime(2016, 1, 1)
# end date (if None, any date is OK as end date), as datetime
my_filter_end_date = datetime.datetime.now()  # datetime.datetime(2016, 12, 31)
